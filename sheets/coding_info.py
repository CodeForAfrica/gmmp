...
#section mapping
newspaper_qs = {'story':{'1':'page_number', 'z':'covid19', '2':'topic'	,'3':'scope', '4':'space'},
             'analysis': {'5':'equality_rights','6':'about_women','7':'inequality_women','8':'stereotypes'},
             'journalists':{'9':'sex'},
             'people':{'10':'sex','11':'age','12':'occupation','13':'function','14':'family_role','15':'victim_or_survivor',	
                       '16':'victim_of','17':'survivor_of','18':'is_quoted'	,'19':'is_photograph','20':'special_qn_1','21':'special_qn_2','22':'special_qn_3'},
             'further_analysis':{'24':'further_analysis'},
             'comments':{'30':'comments'}}


radio_qs = {'story':{'1':'item_number', 'z':'covid19', '2':'topic'	,'3':'scope'},
         'analysis': {'4':'equality_rights','5':'about_women','6':'inequality_women','7':'stereotypes'},
         'journalists':{'8':'role','9':'sex'},
         'people':{'10':'sex','11':'age','12':'occupation','13':'family_role','14':'victim_or_survivor',	
                '15':'victim_of','16':'survivor_of','17':'special_qn_1','18':'special_qn_2','19':'special_qn_3'},
         'further_analysis':{'20':'further_analysis'},
         'comments':{'30':'comments'}}

television_qs = {'story':{'1':'item_number', 'z':'covid19', '2':'topic'	,'3':'scope'},
         'analysis': {'4':'equality_rights','5':'about_women','6':'inequality_women','7':'stereotypes'},
         'journalists':{'8':'role','9':'sex', '10':'age'},
         'people':{'11':'sex','12':'age','13':'occupation','14':'function','15':'family_role','16':'victim_or_survivor',	
                '17':'victim_of','18':'survivor_of','19':'special_qn_1','20':'special_qn_2','21':'special_qn_3'},
         'further_analysis':{'22':'further_analysis'},
         'comments':{'30':'comments'}}


internet_qs = {'story':{'1':'webpage_layer_no', 'z':'covid19', '2':'topic'	,'3':'scope', '4':'shared_via_twitter','5':'shared_via_facebook'},
            'analysis': {'6':'equality_rights','7':'about_women','8':'inequality_women','9':'stereotypes'},
            'journalists':{'10':'role','11':'sex'},
            'people':{'12':'sex','13':'age','14':'occupation','15':'function','16':'family_role','17':'victim_or_survivor',
                   '18':'victim_of','19':'survivor_of','20':'is_quoted','21':'is_photograph','22':'special_qn_1','23':'special_qn_2','24':'special_qn_3'},
            'further_analysis':{'25':'further_analysis'},
            'comments':{'30':'comments'}}

twitter_qs = {'story':{'1':'retweet', 'z':'covid19', '2':'topic'},
            'analysis': {'3':'equality_rights','4':'about_women','5':'inequality_women','6':'stereotypes'},
            'journalists':{'7':'role','8':'sex'},
            'people':{'9':'sex','10':'age','11':'occupation','12':'function','13':'is_photograph','14':'special_qn_1','15':'special_qn_2','16':'special_qn_3'},
            'further_analysis':{'18':'further_analysis'},
            'comments':{'30':'comments'}}


question_models = OrderedDict([
    ('Print', newspaper_qs),
    ('Radio', radio_qs),
    ('Televison', television_qs),
    ('Internet', internet_qs),
    ('Twitter', twitter_qs)
])
...
journalist_dict = {'NewspaperCoding': {'9': 'sex'},
                    ...
                    'InternetCoding' :{'10': 'sex', '11': 'age'},
                    'TwitterCoding': {'7': 'sex', '8': 'age'}}
