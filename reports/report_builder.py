...
class XLSXReportBuilder:
    ...
    def ws_93(self, ws, gen_csv=False):
        ...
        for region_id, region in self.all_regions:
            ...
            if not gen_csv:
                ...
                generate_csv("women_center_of_focus_93", ["Region", "Topic", "Answer", "Count"], counts, ws_93_csv, region=region)
    ...
    def ws_97(self, ws, gen_csv=False):
        ...
        if not gen_csv:
            ...
            generate_csv("challenging_stereotypes_97", ["Region", "Topic", "Agree/Disagree", "Count"], secondary_counts, ws_97_csv, regions=self.all_regions)
