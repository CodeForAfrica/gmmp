...
class Journalist(models.Model):
    ...
    age = models.PositiveIntegerField(verbose_name=_('Age (person appears)'))
...
class Person(models.Model):
    ...
    family_role = models.PositiveIntegerField(choices=YESNO, verbose_name=_('Family Role Given'))
    victim_or_survivor = models.PositiveIntegerField(choices=YESNO, verbose_name=_('Does the story identify the person as either a victim or survivor?'))
    ...
    is_quoted = models.PositiveIntegerField(choices=YESNO, verbose_name=_('Is the person directly quoted'))
