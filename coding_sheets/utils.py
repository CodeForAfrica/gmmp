        ...
        for row in radio_coding_data.get("story_label", []):
            ...
            if radio_news_serializer.is_valid():
                ...
                while has_person(radio_coding_data, row):
                    save_person_data(
                        radio_coding_data, person_data, row, RadioPersonSerializer
                    )
                    save_journalist_data(
        ...
        for row in tv_coding_data.get("story_label", []):
            ...
            if tv_news_serializer.is_valid():
                ...
                while has_person(tv_coding_data, row):
                    save_person_data(
                        tv_coding_data, person_data, row, TelevisionPersonSerializer
                    )
                    save_journalist_data(
        ...
        for row in twitter_coding_data.get("story_label", []):
            ...
            if twitter_news_serializer.is_valid():
                ...
                while has_person(twitter_coding_data, row):
                    save_person_data(
                        twitter_coding_data, person_data, row, TwitterPersonSerializer
                    )
                    save_journalist_data(
